	...
	public void start(Stage primaryStage) throws Exception {
		...
		for (int i = 0; i < tableroVirtual.DevolverCantidadFilasTablero(); i++) {
			for (int j = 0; j < tableroVirtual.DevolverCantidadColumnasTablero(); j++) {
				...
				} else if (tableroVirtual.DevolverCodigoImagenMatriz(i, j).equals("H")||tableroVirtual.DevolverCodigoImagenMatriz(i, j).equals("T")) {
					String s= tableroVirtual.DevolverCodigoImagenMatriz(i, j)+".gif";
					Image im = new Image(s, 40, 40, true, true);
